...
@XmlSchema(namespace = SrwResponse.NS_SRW, xmlns = {
		...
		@XmlNs(namespaceURI = SrwResponse.NS_DC, prefix = "dc") }, elementFormDefault = javax.xml.bind.annotation.XmlNsForm.QUALIFIED)package eu.europeana.api2.v2.model.xml.srw;
