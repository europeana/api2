...
public class Api2UrlServiceTest {
    ...
    void shouldReturnConfiguredPortalBaseUrlForRoute() {
        ...
        Api2UrlService service = new Api2UrlService(urlMap, "", configApi2Url, apikeyValidateUrl, configGatewayUrl);
    ...
    void testGetRecordPortalUrl() {
        ...
        Api2UrlService s1 = new Api2UrlService(urlMap, "", configApi2Url, apikeyValidateUrl, configGatewayUrl);
        ...
        Api2UrlService s2 = new Api2UrlService(urlMap, "", configApi2Url, apikeyValidateUrl, configGatewayUrl);
    ...
    void testGetThumbnailUrl() {
        ...
        Api2UrlService s1 = new Api2UrlService(urlMap, "", configApi2Url, apikeyValidateUrl, apiGatewayBaseUrl);
        ...
        Api2UrlService s2 = new Api2UrlService(urlMap, "", configApi2Url, apikeyValidateUrl, apiGatewayBaseUrl);
        // In this case https:// is added by UrlBuilder class!
