...
public class ControllerUtilsTest {
    ...
    private static String QUERY_2 = "wskey=test&rows=2&profile=translate,minimal,hits&profile=debug";
    private static String QUERY_3 = "profile=translate&wskey=test&rows=2&profile=minimal+hits&profile=debug";
    private static String QUERY_4 = "profile=test&wskey=happy&page=1&view=list&query=hola&qf=contentTier%253A%25281%2520OR%25202%2520OR%25203%2520OR%25204%2529&profile=minimal&profile=minimal%252Ctranslate&rows=24&start=1&lang=es&q.source=es&q.target=en";
