...
import eu.europeana.api2.v2.utils.GeoUtils;
...
public class SearchControllerTest {
    ...
    @Before
    public void setup() {
        searchController = new SearchController(null, null);
    }
    ...
    public void testProcessQFParameters () throws EuropeanaException {
        ...
        refinementArray =  searchController.processQfParameters(refinementArray, false, false,false, false, filterTags, geoUtils);
    ...
    @Test(expected = EuropeanaException.class)
    public void whenExceptionThrown_thenExpectationSatisfied() throws EuropeanaException {
        final List<Integer> filterTags = new ArrayList<>();
        GeoUtils geoUtils = new GeoUtils();
