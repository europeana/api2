...
public class ExceptionControllerAdvice extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMissingServletRequestParameter(
        ...
        ModelAndView mav = JsonUtils.toJson(new ApiError("", "search.json", "missing parameters"));
        return new ResponseEntity<>(mav.getModel().get("json"), headers, HttpStatus.BAD_REQUEST);
    }
}
