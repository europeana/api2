...
import eu.europeana.api2.v2.service.search.syntax.model.ArgumentExpression;
import eu.europeana.api2.v2.service.search.syntax.model.FieldQueryExpression;
import eu.europeana.api2.v2.service.search.syntax.model.FunctionExpression;
import eu.europeana.api2.v2.service.search.syntax.model.ValueExpression;
...
public class DateFunction implements FunctionClass {
    ...
    */
    ...
    public String toSolr(FunctionExpression expr, ConverterContext context) {
        ...
        String date      = getDate(params.get(1));
    ...
    private String getDate(ArgumentExpression arg) {
        if ( arg instanceof ValueExpression ) {
            ValueExpression expr = (ValueExpression)arg;
