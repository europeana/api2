...
public class OAuth2ClientDetailsService implements org.springframework.security.oauth2.provider.ClientDetailsService {
	...
	public ClientDetails loadClientByClientId(String oauthClientId) throws OAuth2Exception {
		try {
			...
			if (apiKey != null) {
				return new Api2OAuth2ClientDetails(apiKey.getId(), apiKey.getPrivateKey());
			}
